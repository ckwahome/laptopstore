...
export const Testimonials = () => {
  const testimonials = [
    { name: 'Ann Mwangi', role: 'Fashion Designer', quote: 'Great selection and amazing customer service!' },
    { name: 'James Karanja.', role: 'Buyer', quote: 'Quality products at unbeatable prices.' },
    { name: 'Lina Salome.', role: 'Stylist', quote: 'I found unique pieces that my clients love.' },
  ]
